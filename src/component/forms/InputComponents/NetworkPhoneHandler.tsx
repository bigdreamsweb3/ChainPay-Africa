      ...
      <div className="flex items-center gap-2">
        <div className="relative" ref={dropdownRef}>
          <motion.button
            ...
            className="flex items-center bg-gradient-to-r from-green-400 to-blue-500 border border-gray-300/50 rounded-lg py-1 px-3 hover:border-blue-500 transition-all duration-300 focus:outline-none focus:shadow-md "
          ...
          <AnimatePresence>
            {isDropdownOpen && (
              <motion.div
                ...
                exit={{ opacity: 0, y: -10 }}
                className="absolute z-10 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden"
              >
        ...
        <motion.div className="flex-1 relative" whileHover={{ scale: 1.02 }}>
          ...
          <input
            ...
            className="w-full px-4 py-2 pl-10 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 bg-gray-50"
          />
        </motion.div>
      </div>
