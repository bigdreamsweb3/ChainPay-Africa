...
const NetworkPhoneHandler: React.FC<PhoneNumberInputProps> = ({
  ...
  return (
    <div className="bg-white inset-0 bg-gradient-to-r from-transparent via-chainpay-blue/5 to-transparent">
      <div className="space-y-3 inset-0 rounded-[8px] p-4 shadow-md border border-chainpay-blue-light/20">
        {/* <div className="flex items-center gap-2">
          <h3 className="text-sm font-bold bg-gradient-to-r from-chainpay-blue-dark to-brand-primary bg-clip-text text-transparent flex items-center gap-1.5">
          ...
          <div className="flex-1 relative">
            ...
            >
              <input
                ...
                className="w-full h-11 px-3 pr-10 text-sm font-medium rounded-lg transition-all duration-200 ease-in-out
            ...
            <AnimatePresence>
              {isDropdownOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: -5 }}
                  className="absolute z-50 right-0 mt-2 w-48 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg border border-chainpay-blue-light/30 overflow-hidden"
                >
                  <div className="p-1.5">
